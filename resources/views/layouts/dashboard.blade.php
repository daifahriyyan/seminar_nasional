...
<html lang="en" data-bs-theme="auto">
  <head><script src="/assets/dashboard/js/color-modes.js"></script>
...
<link href="assets/dashboard/dist/css/bootstrap.min.css" rel="stylesheet">
...
<div class="container-fluid">
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-db">
      <div class="offcanvas-md offcanvas-end bg-db" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="/buktiPembayaran">
                <img src="assets/icon/clipboard.svg" width="15">
                Bukti Pembayaran
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="https://techcomfest.ukmpcc.org">
                <img src="assets/icon/logo.png" width="15">
                Techcomfest
              </a>
            </li>
          </ul>
            ...
            <li class="nav-item">
                <form action="/logout" method="POST">
                  ...
                  <button type="submit" class="nav-link d-flex align-items-center gap-2 text-danger"> 
                    <svg class="bi"><use xlink:href="#door-closed"/></svg>Sign Out
                  </button>
                </form>
            </li>
          </ul>
...
<script src="assets/dashboard/dist/js/bootstrap.bundle.min.js"></script>
