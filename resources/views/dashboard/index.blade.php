...
<header class="navbar sticky-top bg-db flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">
    <img src="assets/Logo.png" alt="Logo PCC" width="25">Seminar Nasional
  </a>
          ...
          <div class="card bg-body-tertiary pt-3">
            ...
            <div class="tab-content pt-2 p-4">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <p class="fst-italic">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</p>

                <h5 class="card-title mb-3">Profile Details</h5>

                <div class="row">
                  <p class="col-lg-3 col-md-4 label ">Full Name</p>
                ...
                <div class="row">
                  <p class="col-lg-3 col-md-4 label">Motivasi</p>
                  <p class="col-lg-9 col-md-8">{{ auth()->user()->motivasi }}</p>
                </div>

                <div class="row">
                  <p class="col-lg-3 col-md-4 label">Address</p>
                  <p class="col-lg-9 col-md-8">A108 Adam Street, New York, NY 535022</p>
                </div>
